import{r as b,_ as T,C as v,c as C,E as Y,o as be,F as J,L as Te,b as X,m as ve,n as Ae,v as Se,q as L,g as Ce,s as Ee,t as ke,f as Re,j as Pe,h as _e,w as Oe,x as De}from"./index-8e6e89cb.DEJTO7eW.js";const Z="@firebase/installations",D="0.6.17";/**
 * @license
 ...
 */const Q=1e4,ee=`w:${D}`,te="FIS_v2",Fe="https://firebaseinstallations.googleapis.com/v1",Me=60*60*1e3,Ne="installations",xe="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dt=30,Ft=1e3;class Mt{constructor(t={},n=Ft){this.throttleMetadata=t,this.intervalMillis=n}getThrottleMetadata(t){return this.throttleMetadata[t]}setThrottleMetadata(t,n){this.throttleMetadata[t]=n}deleteThrottleMetadata(t){delete this.throttleMetadata[t]}}const we=new Mt;function Nt(e){return new Headers({Accept:"application/json","x-goog-api-key":e})}async function xt(e){var t;const{appId:n,apiKey:a}=e,i={method:"GET",headers:Nt(a)},s=Tt.replace("{app-id}",n),r=await fetch(s,i);if(r.status!==200&&r.status!==304){let o="";try{const c=await r.json();!((t=c.error)===null||t===void 0)&&t.message&&(o=c.error.message)}catch{}throw p.create("config-fetch-failed",{httpStatus:r.status,responseMessage:o})}return r.json()}async function $t(e,t=we,n){const{appId:a,apiKey:i,measurementId:s}=e.options;if(!a)throw p.create("no-app-id");if(!i){if(s)return{measurementId:s,appId:a};throw p.create("no-api-key")}const r=t.getThrottleMetadata(a)||{backoffCount:0,throttleEndTimeMillis:Date.now()},o=new qt;return setTimeout(async()=>{o.abort()},bt),Ie({appId:a,apiKey:i,measurementId:s},r,o,t)}async function Ie(e,{throttleEndTimeMillis:t,backoffCount:n},a,i=we){var s;const{appId:r,measurementId:o}=e;try{await Lt(a,t)}catch(c){if(o)return d.warn(`Timed out fetching this Firebase app's measurement ID from the server. Falling back to the measurement ID ${o} provided in the "measurementId" field in the local Firebase config. [${c?.message}]`),{appId:r,measurementId:o};throw c}try{const c=await xt(e);return i.deleteThrottleMetadata(r),c}catch(c){const l=c;if(!jt(l)){if(i.deleteThrottleMetadata(r),o)return d.warn(`Failed to fetch this Firebase app's measurement ID from the server. Falling back to the measurement ID ${o} provided in the "measurementId" field in the local Firebase config. [${l?.message}]`),{appId:r,measurementId:o};throw c}const u=Number((s=l?.customData)===null||s===void 0?void 0:s.httpStatus)===503?L(n,i.intervalMillis,Dt):L(n,i.intervalMillis),f={throttleEndTimeMillis:Date.now()+u,backoffCount:n+1};return i.setThrottleMetadata(r,f),d.debug(`Calling attemptFetch again in ${u} millis`),Ie(e,f,a,i)}}function Lt(e,t){return new Promise((n,a)=>{const i=Math.max(t-Date.now(),0),s=setTimeout(n,i);e.addEventListener(()=>{clearTimeout(s),a(p.create("fetch-throttle",{throttleEndTimeMillis:t}))})})}function jt(e){if(!(e instanceof J)||!e.customData)return!1;const t=Number(e.customData.httpStatus);return t===429||t===500||t===503||t===504}class qt{constructor(){this.listeners=[]}addEventListener(t){this.listeners.push(t)}abort(){this.listeners.forEach(t=>t())}}async function Bt(e,t,n,a,i){if(i&&i.global){e("event",n,a);return}else{const s=await t,r=Object.assign(Object.assign({},a),{send_to:s});e("event",n,r)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
